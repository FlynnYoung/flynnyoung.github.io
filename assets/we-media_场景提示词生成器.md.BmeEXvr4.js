import{_ as i,o as n,c as a,a8 as l}from"./chunks/framework.DHvjfnCH.js";import"./chunks/theme.CiN_d4is.js";const o=JSON.parse(`{"title":"场景图像提示词生成器-漫剧","description":"","frontmatter":{"title":"场景图像提示词生成器-漫剧","tags":["提示词","漫剧"],"categories":["自媒体","短视频","提示词"],"sort":6,"head":[["script",{"charset":"UTF-8","id":"LA_COLLECT","src":"//sdk.51.la/js-sdk-pro.min.js"}],["script",{},"typeof LA !== 'undefined' && LA.init({\\"id\\":\\"3PBnZvPCAEN6PMYo\\",\\"ck\\":\\"3PBnZvPCAEN6PMYo\\",\\"hashMode\\":true})"]]},"headers":[],"relativePath":"we-media/场景提示词生成器.md","filePath":"we-media/场景提示词生成器.md"}`),h={name:"we-media/场景提示词生成器.md"};function p(k,s,t,e,E,d){return n(),a("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1783318648505"},[...s[0]||(s[0]=[l(`<h1 id="场景图像提示词生成器" tabindex="-1">场景图像提示词生成器 <a class="header-anchor" href="#场景图像提示词生成器" aria-label="Permalink to “场景图像提示词生成器”">​</a></h1><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">## 系统角色</span></span>
