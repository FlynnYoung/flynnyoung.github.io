import{_ as i,o as a,c as n,a8 as l}from"./chunks/framework.DM78xnLg.js";import"./chunks/theme.D5D1hZr1.js";const g=JSON.parse('{"title":"角色图片生成提示词-漫剧","description":"","frontmatter":{"title":"角色图片生成提示词-漫剧","tags":["提示词","漫剧"],"categories":["自媒体","短视频","提示词"],"sort":3},"headers":[],"relativePath":"we-media/角色图片生成提示词.md","filePath":"we-media/角色图片生成提示词.md"}'),e={name:"we-media/角色图片生成提示词.md"};function t(h,s,p,k,r,E){return a(),n("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1772370078000"},[...s[0]||(s[0]=[l(`<h1 id="角色图片生成提示词" tabindex="-1">角色图片生成提示词 <a class="header-anchor" href="#角色图片生成提示词" aria-label="Permalink to “角色图片生成提示词”">​</a></h1><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># Character Orthographic Reference Sheet Generator</span></span>
