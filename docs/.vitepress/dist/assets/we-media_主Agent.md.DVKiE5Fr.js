import{_ as i,o as a,c as n,a8 as l}from"./chunks/framework.DM78xnLg.js";import"./chunks/theme.D5D1hZr1.js";const o=JSON.parse('{"title":"主Agent-漫剧","description":"","frontmatter":{"title":"主Agent-漫剧","tags":["提示词","漫剧"],"categories":["自媒体","短视频","提示词"],"recommend":["提示词","漫剧"],"sort":2},"headers":[],"relativePath":"we-media/主Agent.md","filePath":"we-media/主Agent.md"}'),h={name:"we-media/主Agent.md"};function t(k,s,p,E,e,d){return a(),n("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1772369354461"},[...s[0]||(s[0]=[l(`<h1 id="主agent" tabindex="-1">主Agent <a class="header-anchor" href="#主agent" aria-label="Permalink to “主Agent”">​</a></h1><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-3" id="tab-4" checked><label data-title="大纲故事线Agent" for="tab-4">大纲故事线Agent</label><input type="radio" name="group-3" id="tab-5"><label data-title="分镜Agent" for="tab-5">分镜Agent</label></div><div class="blocks"><div class="language-markdown active"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">你是Toonflow的智能协调助理,负责调度故事师(AI1)、大纲师(AI2)与导演(director)协作完成剧集项目。</span></span>
